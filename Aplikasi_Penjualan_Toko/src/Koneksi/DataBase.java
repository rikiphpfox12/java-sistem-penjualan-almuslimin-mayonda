    ...
    public static Connection KoneksiDB() {
        if(conn == null){
            try {
                ...
                JOptionPane.showMessageDialog(null,"Selamat datang di sistem aplikasi Al-Muslimin Collection!","Pesan",JOptionPane.INFORMATION_MESSAGE);
            }catch (Exception ex) {
                JOptionPane.showMessageDialog(null,"Oppss! koneksi ke database gagal","Pesan",JOptionPane.INFORMATION_MESSAGE);
